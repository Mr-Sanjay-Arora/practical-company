      ...
      <tbody class="bg-white divide-y divide-gray-200 ">
        ...
        <tr class="">
          ...
          <td class="px-6 py-4 whitespace-nowrap">
            <div class="flex items-center">
              <div class="ml-0">
                <div class="text-sm text-gray-900">{{$list->city}}</div>
              </div>
            </div>
          </td>
          ...
          <td class="px-6 py-4 whitespace-nowrap">
            <div class="text-sm text-gray-900"><a href="/view-company/{{$list->id}}">View</a></div>
            <div class="text-sm text-gray-900"><a href="/delete-company/{{$list->id}}">Delete</a></div>
          </td>
        @endforeach
      </tbody>
    </table>
